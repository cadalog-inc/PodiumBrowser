                ...
                <Modal show={this.props.show} onHide={this.props.handleClose}>
                    ...
                    <Modal.Body>
                        <Form>
                            ...
                            <Row>
                                <Col>
                                    <img alt="" style={{ width: '100%' }} src={`https://v3.pdm-plants-textures.com/images/files/${this.props.item.hash.substring(0, 2)}/${this.props.item.hash}.${this.props.item.thumbnailExt}`} />
                                </Col>
                            </Row>
                            <Row>
                                <Col>
